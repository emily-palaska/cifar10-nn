...
class NeuralNetwork:
    ...
    def train(self, X_train, y_train, epochs=1000, learning_rate=0.01):
        ...
        with open("output[512,256,128,64,32,16].txt", "w") as file:
            file.write(f"Cifar-10 training with hidden layers {self.layers}.\n")
        
        # Repeat training loop for every epoch
        loss_per_epoch = []
        ...
        for epoch in range(epochs):
            ...
            # Update file
            with open("output[512,256,128,64,32,16].txt", "a") as file:
...
hidden_sizes = [512, 256, 128, 64, 32, 16] # neurons per layer
