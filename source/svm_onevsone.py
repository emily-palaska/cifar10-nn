...
def main():
    ...
    lambda_param = 0.01
    n_iters = 10
    file_name = f'../results/svm/1v1_lr{learning_rate}_l{lambda_param}_n{n_iters}.json'
    classifier = mysvm.OneVsOneClassifier(learning_rate=learning_rate, lambda_param=lambda_param, n_iters=n_iters, results_file=file_name)
